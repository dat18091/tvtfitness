...
public class ThemDichVuController extends HttpServlet {
	...
	private final String UPLOAD_DIRECTORY = "D:\\Lap Trinh\\Java\\Javaweb\\tvtfitness\\WebContent\\resources\\uploads";
...
//                }
		...
		Service service = new Service(serviceId, serviceName, serviceType, fileName, serPrice);
		try {
