...
<html lang="en">
<head>
	<title>TVT Fitness | Services</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 order-lg-1 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="<c:url value="/resources/web/img/services/services-1.jpg" />" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-3 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="<c:url value="/resources/web/img/services/services-2.jpg" />" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-8 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="/resources/web/img/services/services-4.jpg" alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-3 order-lg-6 col-md-6 p-0">
                    <div class="ss-pic">
                        <img src="<c:url value="/resources/web/img/services/services-3.jpg" />" alt="">
                    </div>
                </div>
